...
def save_dataset(
    ...
    Parameters:
        ...
        filename_appendix (str): Appendix to add to filename when saving file.
    ...
    file_name = f"{file_type}_{bird_name}_{timestamp}_{filename_appendix}.pkl"
